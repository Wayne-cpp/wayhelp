...
-- 本章两种拒答都入池:检索证据低(retrieval_low_conf)/ 生成自评不足(self_check);user_feedback 留给后续章节反馈信号
-- =============================================================
...
CREATE TABLE faith_cases (
  ...
  bucket        VARCHAR(24)     NOT NULL                COMMENT '题目所属桶:A_policy / B_model / C_colloquial / D_absent / E_multi',
